function t396_scaleBlock(e) {
  var u,
    ...
    a = o ? o.querySelectorAll('.t396__elem') : [],
    y = o ? o.querySelector('.t396__artboard') : null;
  y &&
    ((u =
      (u = window.tn && window.tn['ab' + e] && window.tn['ab' + e].scaleFactor) ||
    ...
    Array.prototype.forEach.call(a, function (e) {
      ...
      if ('grid' === l)
        if (h) {
          t &&
            (s = t.parentNode) &&
            !s.closest('.tn-atom__scale-wrapper') &&
          ...
          l &&
            ...
            '0px' !== (l = getComputedStyle(t).borderRadius) && (d.style.borderRadius = l)),
            'shape' === o &&
              t &&
              t.style.backgroundImage &&
              'fixed' === getComputedStyle(t).backgroundAttachment &&
              ...
              (p = parseFloat(t396_elem__getFieldValue(e, 'top'))),
              (m = parseFloat(t396_elem__getFieldValue(e, 'left'))),
              (e.style.top = p * u + 'px'),
              (e.style.left = m * u + 'px'),
          ...
          var l = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
            a =
              (('text' !== o && 'button' !== o) ||
                ...
                (a = t.style.webkitTextSizeAdjust),
                (t.style.webkitTextSizeAdjust = 'none'),
                (e.style.zoom = u),
                (_ = parseFloat(getComputedStyle(t).fontSize)),
                (_ = Math.round(_)),
                (_ = Math.abs(i - _)),
                (t.style.webkitTextSizeAdjust = a),
                1 <= _ &&
                  ((t.style.fontSize = i * u + 'px'), (t.style.webkitTextSizeAdjust = 'none'))),
              (e.style.zoom = u),
          ...
          if ('video' !== o && a && !_ && !i && !r) {
            ...
            var s,
              ...
              m =
                ((p =
                  (p = t396_elem__convertPosition__Local__toAbsolute(e, 'top', p)) * u +
                  (n * u - n) / 2),
                parseFloat(t396_elem__getFieldValue(e, 'left')));
            for (
              m =
                (m = t396_elem__convertPosition__Local__toAbsolute(e, 'left', m)) * u +
                (c * u - c) / 2,
                e.style.top = p + 'px',
                e.style.left = m + 'px',
                (s = t.parentNode) &&
          ...
          'shape' === o &&
            ...
            (c = t396_elem__convertPosition__Local__toAbsolute(e, 'width', c)),
            (p = parseFloat(t396_elem__getFieldValue(e, 'top'))),
            (p = t396_elem__convertPosition__Local__toAbsolute(e, 'top', p)),
            (m = parseFloat(t396_elem__getFieldValue(e, 'left'))),
            (m = t396_elem__convertPosition__Local__toAbsolute(e, 'left', m)),
            (i = (a = window.getComputedStyle(t)).borderWidth),
            (r = 'none' !== a.backgroundImage),
            ...
            !(n <= 2 || c <= 2) ||
              ...
              (e.style.height = parseFloat(a) + 'px'),
