    ...
    !l.isInited &&
      ...
      Array.prototype.forEach.call(l.fixedElements, function (t) {
        ...
        !document.body.contains(a) ||
          ...
          a.classList.contains('t975') ||
          ('fixed' !== (e = (i = t.computedStyle).getPropertyValue('position')) &&
            'absolute' !== e) ||
          ((o = i.getPropertyValue('transition-duration')).indexOf('ms') + 1
            ? ((o = parseInt(o.replace('ms', ''), 10)), r.push(o))
            : o.indexOf('s') + 1 && ((o = 1e3 * parseFloat(o.replace('s', ''))), r.push(o)),
          ...
          (t =
            '100%' === t ||
            t === window.innerWidth + 'px' ||
            t === window.innerWidth - l.scrollBarWidth + 'px' ||
            '100vw' === t),
          (o =
            '100%' === o ||
            o === window.innerHeight + 'px' ||
            o === window.innerHeight - l.scrollBarWidth + 'px' ||
            'auto' === o ||
            '100vh' === o),
          (!n && 0 !== n) || 'auto' === a.style.right || 'absolute' === e || t
            ? t && !o && (a.style.width = 'calc(100vw - ' + l.scrollBarWidth + 'px)')
...
(window.isSearchBot = !1),
  ...
  (function () {
    ...
    function t() {
      for (
        var t, e, n, i, o = document.querySelectorAll('.t-cover__carrier'), a = 0, r = 0;
        r < o.length;
        r++
      )
      ...
      for (
        ...
        -1 < (d = (l = s[r]).style).height.indexOf('vh') &&
          ((a = parseInt(d.height) / 100), (t = c + 'px'), (d.height = t));
    }
    function e() {
        ...
        for (
          ...
          if (t < u) {
            if (
              ...
              'false' === c.parentNode.getAttribute('[data-auto-correct-mobile-width]')
            )
              return;
            console.log(
      ...
      for (
        ...
        r &&
          ...
          document.documentElement.clientWidth > t
            ? ((o = (o = r.replace('lineheight', 'line-height')).replace('fontsize', 'font-size')),
    ...
    setTimeout(function () {
      for (
        ...
        '' === i
          ...
          : -1 === i.indexOf('noopener') && n.setAttribute('rel', i + ' noopener');
      }
    }, 2500);
  }),
  (function (a) {
    a.onerror = function (t, e, n, i, o) {
      'object' != typeof a.t_jserrors && (a.t_jserrors = []),
        a.t_jserrors.push({ message: t, filename: e, lineno: n, colno: i, error: o });
    };
  })(window, Math),
  t_onReady(function () {
