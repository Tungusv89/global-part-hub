(window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language)
  ...
  t_onReady(function () {
    ...
    t &&
      ((e = t.getAttribute('data-tilda-project-lang')) && (window.t_forms__lang = e),
        ...
        switch (c) {
          ...
          case 'phone':
            ...
            v &&
              (-1 !== v.indexOf('*')
                ? (E += 'a-zёа-я')
                : (-1 !== v.indexOf('a') && (E += 'a-z'), -1 !== v.indexOf('а') && (E += 'а-яё'))),
              (E += ']+$'),
              (d = new RegExp(E, 'gi')),
              ((w.length && !w.match(d)) ||
            ...
            break;
          case 'number':
            (d = /^[0-9]+$/gi), 0 < w.length && !w.match(d) && f.type.push('number');
            break;
          case 'date':
            0 < w.length &&
              !w.match(
            ...
            break;
          case 'time':
            (d = /^[0-9]{2}[:\.][0-9]{2}$/gi), 0 < w.length && !w.match(d) && f.type.push('time');
            break;
          case 'name':
            (d =
  ...
  (window.tildaForm.showErrorInPopup = function (t, e) {
      ...
      t_addEventListener(
        ...
        function (t) {
          if (((t = t || window.event).target || t.srcElement).closest('.js-errorbox-close'))
            return t.preventDefault ? t.preventDefault() : (t.returnValue = !1), t_fadeOut(d), !1;
        },
      ));
    for (var u, m, p, f = 0; f < e.length; f++)
      if (e[f] && e[f].obj) {
        if (0 === f && 'none' === e[f].obj) {
        ...
        for (var w = 0; w < e[f].type.length; w++) {
          ...
          (r = t.querySelector('.js-rule-error-' + y))
            ? (r.textContent && r.innerText) || !h || -1 !== c.indexOf(h)
              ? ((l = r.textContent || r.innerText),
                -1 === c.indexOf(l) && (c = c + '<p class="t-form__errorbox-item">' + l + '</p>'))
              : (c = c + '<p class="t-form__errorbox-item">' + h + '</p>')
            : h &&
              -1 === c.indexOf(h) &&
              (c = c + '<p class="t-form__errorbox-item">' + h + '</p>'),
            i &&
    ...
    function g(t) {
      'INPUT' === ((t = t || window.event).target || t.srcElement).tagName &&
        ((t = m.querySelectorAll('form .t-input-error')),
        t_fadeOut(d),
        Array.prototype.forEach.call(t, function (t) {
    ...
    return (
      c &&
        ...
        (u = d.querySelectorAll('.t-form__errorbox-item')),
        Array.prototype.forEach.call(u, function (t) {
          t.style.display = 'block';
        }),
        document.querySelector('.t1093 [data-elem-type="form"]') &&
          ((u = window.tPopupObj && window.tPopupObj.openPopUpList) && u.length
            ? ((p = '.t1093 .t-popup[data-tooltip-hook="' + u[u.length - 1] + '"]'),
              1e4 < (p = (p = document.querySelector(p)) ? getComputedStyle(p).zIndex : 0) &&
                (d.style.zIndex = p + 1))
            : (d.style.zIndex = '')),
        t_fadeIn(d)),
      ...
      window.isInitEventsZB[o] ||
        ((m = t.closest('.r')),
        (p = 'focus'),
        document.addEventListener || (p = 'focusin'),
        t_removeEventListener(m, p, g),
        t_addEventListener(m, p, g, !0),
        t_removeEventListener(m, 'change', g),
        t_addEventListener(m, 'change', g, !0)),
      ...
      if (e[c] && e[c].obj) {
        if (0 === c && 'none' === e[c].obj) {
          ...
          for (var d = 0; d < n.length; d++) {
            (n[d].innerHTML =
              '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg('emptyfill') + '</a>'),
              (n[d].style.display = 'block');
            var u = t.querySelectorAll('.t-input')[0];
            u && t_forms__moveToErrorInput(u.getAttribute('id'), n[0]);
          }
          break;
        }
        var m = e[c].obj;
        ...
        for (d = 0; d < e[c].type.length; d++) {
          var p = e[c].type[d],
            f = e[c].obj.id,
            s = '';
          if ((1, (n = t.querySelectorAll('.js-rule-error-' + p)).length))
            for (var _ = 0; _ < n.length; _++)
              (w = n[_]).getAttribute('data-rule-filled')
                ? (w.style.display = 'block')
                : ((w.textContent && w.innerText) || !t_forms__getMsg(p)
                    ? (s = n[0].textContent || n[0].innerText)
                    : (w.innerHTML =
                        '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(p) + '</a>'),
                  (w.style.display = 'block'),
                  -1 === l.indexOf(p) && t_forms__moveToErrorInput(f, w),
                  l.push(p));
          else if (t_forms__getMsg(p) && (n = t.querySelectorAll('.js-rule-error-all')).length)
            for (var w, _ = 0; _ < n.length; _++)
              ((w = n[_]).innerHTML =
                '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(p) + '</a>'),
                (w.style.display = 'block'),
                -1 === l.indexOf(p) && t_forms__moveToErrorInput(f, w),
  ...
  (window.tildaForm.addMebersInfoToForm = function (t) {
    ...
    try {
      ...
      if ((e && t_removeEl(e), !window.mauser || !window.mauser.code || !window.mauser.email))
        return !1;
            ...
            if (200 <= xhr.status && xhr.status < 400) {
                ...
                if ('object' == typeof objData) {
                  ...
                  if (
                    ...
                    if (objData && objData.next && objData.next.type)
                      return (
                        window.tildaForm.payment(form, objData.next), (dataSuccessUrl = ''), !1
                      );
              ...
              if (!xhr || (0 == xhr.status && tsDelta < 100))
                ...
                xhr && xhr.responseText
                  ? Array.prototype.forEach.call(allError, function (t) {
                      t.innerHTML =
                        '[' + xhr.status + '] ' + xhr.responseText + '. Please, try again later.';
                    })
                  : xhr && xhr.statusText
                  ? Array.prototype.forEach.call(allError, function (t) {
                      t.innerHTML =
        ...
        if (4 === xhr.readyState)
          if (200 <= xhr.status && xhr.status < 400) {
            ...
            window.Tilda && 'function' == typeof window.Tilda.sendEventToStatistics
              ...
              : '' < window.mainMetrika &&
                window[window.mainMetrika] &&
                window[window.mainMetrika].hit(i, { title: t, referer: window.location.href }),
              t_triggerEvent(form, 'tildaform:aftersuccess'),
            ...
            Array.prototype.forEach.call(n, function (t) {
              l
                ...
                : xhr.statusText
                ? (t.innerHTML =
                    'Error [' + xhr.statusText + ']. Please, try again later. [' + xhr.status + ']')
    ...
    ((t = t.querySelectorAll('.t-input, .t-select')) &&
      ...
      Array.prototype.forEach.call(t, function (t) {
        t.addEventListener('focus', function () {
          'keyboard' === e &&
            ((t.classList.contains('t-input_pvis') || t.classList.contains('t-input-phonemask')) &&
              (t = t.parentElement),
...
function t_forms__calculateInputsWidth(t) {
  ...
  var r,
    o,
    e = document.querySelector('#rec' + t);
  t ||
    ...
    !e ||
      ((r = e.querySelector('.t-form__inputsbox')) &&
        ((t = e.querySelectorAll('.t-input-group_widthdef, .t-input-group_inrow')),
        r.classList.contains('t-form__inputsbox_inrow') ||
          (t = e.querySelectorAll('.t-input-block_width')),
        0 !== t.length &&
          ((r.classList.contains('t-form__inputsbox_vertical-form') || r.closest('.t706')) &&
            r.classList.add('t-form__inputsbox_flex'),
          r.closest('.t706') && r.classList.add('t-form__inputsbox_inrow'),
          (o = r.offsetWidth),
          Array.prototype.forEach.call(t, function (t) {
            if (
              (r.classList.contains('t-form__inputsbox_inrow') || (t = t.closest('.t-input-group')),
            ...
            e &&
              ...
              r.classList.contains('t-form__inputsbox_inrow') ||
                t_forms__calculateFieldsWidthInJS(t, o);
          }),
          0 <
            (t = e.querySelectorAll(
              '.t-input-group_inrow.t-input-group_inonerow.t-input-group_inrow-last',
            )).length && t_forms__moveFieldToNextRow(t),
          (e = e.querySelectorAll('.t-input-group_widthdef.t-input-group_inrow-last')),
          r.classList.contains('t-form__inputsbox_inrow') &&
            0 < e.length &&
            t_forms__combineFieldsWithDefWidth(e))));
}
    ...
    t.forEach(function (t) {
      ...
      r ||
        (e = t.reduce(function (t, e) {
          var r = e.classList.value.split(' ').filter(function (t) {
              return -1 !== t.indexOf('t-input-group_width');
            }),
            e = 2;
          return -1 !== (r = r[0]).indexOf('100') && (e = 3), t + Number(r.substr(r.length - 2, e));
        }, 0)) <= 100 ||
        t.forEach(function (t) {
          t.classList.contains('t-input-group_inrow-last') &&
...
function t_forms__combineFieldsWithDefWidth(t) {
  var o = [];
...
function t_parseScripts(n, t) {
  ...
  Array.prototype.forEach.call(t, function (t) {
    ...
    t.innerHTML.length
      ? (r.appendChild(document.createTextNode(t.innerHTML)), t.parentNode.replaceChild(r, t))
...
function t_forms__onSuccess(t) {
  ...
  var d = 't' + r + '__inputsbox_hidden',
    u = [702, 708, 862, 945, 1014],
    m = !0,
    c = 960 < window.innerWidth ? l - 200 : l - 100,
  ...
  _ &&
    ...
    (835 != r && 862 != r) ||
      ...
      (t = e.querySelector('.t' + r + '__wrapper')),
      (e = e.querySelector('.t' + r + '__quiz-form-wrapper')),
    ...
    (function t() {
      ...
      (n += i),
        window.scrollTo(
          0,
          ((e = n),
          (e /= r / 2) < 1 ? (a / 2) * e * e * e + o : (a / 2) * ((e -= 2) * e * e + 2) + o),
        ),
...
function t_serializeArray(t) {
  for (
    var e = [], r = t.querySelectorAll('input, textarea, button, select'), o = 0;
    o < r.length;
    o++
  )
    if (
